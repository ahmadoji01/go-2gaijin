...
func InsertDelivery(c *gin.Context) {
	...
	if isLoggedIn {
		...
		SendDeliveryRequestEmail("", delivery.Name, delivery.Email, delivery.Phone, delivery.WeChat, delivery.Facebook, delivery.Origin, delivery.Destination, localDeliveryTime, delivery.Notes)
		SendDeliverySummaryEmail("", delivery.Name, delivery.Email, delivery.Phone, delivery.WeChat, delivery.Facebook, delivery.Origin, delivery.Destination, localDeliveryTime, delivery.Notes)
...
func InsertAppointmentWithDelivery(c *gin.Context) {
	...
	if isLoggedIn {
		...
		localTime, _ := time.LoadLocation("Asia/Tokyo")
		localDeliveryTime := delivery.DeliveryTime.Time().In(localTime).String()
		SendDeliveryRequestEmail(product.Name, delivery.Name, delivery.Email, delivery.Phone, delivery.WeChat, delivery.Facebook, delivery.Origin, delivery.Destination, localDeliveryTime, delivery.Notes)
