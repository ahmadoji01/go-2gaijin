...
func EmailConfirmation(link string) string {
								...
								<table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
								  ...
								  <tr>
									<td class="td-padding" align="left" style="font-family: 'Roboto Mono', monospace; color: #212121!important; font-size: 24px; line-height: 30px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 13px;">
									  You have requested to confirm your email!
									</td>
								  </tr>
								  <!-- END BODY COPY -->
								  <!-- BUTTON -->
								  <tr>
									<td align="center" style="padding: 18px 18px 18px 18px; mso-alt-padding: 18px 18px 18px 18px!important;">
									  <a class="button raised" href="` + link + `" target="_blank" style="font-size: 24px; line-height: 14px; font-weight: 500; font-family: Helvetica, Arial, sans-serif; background-color: #ff8c00; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 25px 100px; border: 1px solid #17bef7; display: inline-block;">Click Here to Confirm Your Email</a>
...
func ResetPassword(link string) string {
	template := `<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	  <head>
		<meta content="text/html; charset=UTF-8" http-equiv="Content-Type" />
							...
							<tr>
							  <td align="center">
								<table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
								  ...
								  <!-- START BODY COPY -->
								  <tr>
									<td class="td-padding" align="left" style="font-family: 'Roboto Mono', monospace; color: #212121!important; font-size: 12px; line-height: 30px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 13px;">
									  You can ignore this email if this is not coming from you
									</td>
								  </tr>
								  <!-- END BODY COPY -->
								  <!-- BUTTON -->
								  <tr>
									<td align="center" style="padding: 18px 18px 18px 18px; mso-alt-padding: 18px 18px 18px 18px!important;">
									  <a class="button raised" href="` + link + `" target="_blank" style="font-size: 24px; line-height: 14px; font-weight: 500; font-family: Helvetica, Arial, sans-serif; background-color: #ff8c00; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 25px 100px; border: 1px solid #17bef7; display: inline-block;">Click Here to Update Your Password</a>
									  <!-- <table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
										  <td>
											<table border="0" cellspacing="0" cellpadding="0">
