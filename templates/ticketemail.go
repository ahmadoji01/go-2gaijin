...
func TicketEmail(name string, email string, message string) string {
		...
		<tr>
			<td align="center" bgcolor="#D2C7BA">
				...
				<tr>
					...
					<h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">A ticket was requested by someone</h1>
					</td>
				</tr>
				</table>
				<!--[if (gte mso 9)|(IE)]>
		  	...
		  	<td align="center" bgcolor="#D2C7BA">
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
			  	...
			  	<tr>
					<td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
						<p style="margin: 0;">Someone sent a ticket</p>
					</td>
			  	</tr>
			  	<!-- end copy -->
				...
				<!-- end customer's info table -->
			  	...
			  	<tr>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr>
						<td align="left" bgcolor="#D2C7BA" width="100%" style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><strong>Message</strong></td>
						</tr>
						<tr>
							<td align="left" width="100%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">` + message + `</td>
						</tr>
					</table>
					</td>
			  	</tr>
